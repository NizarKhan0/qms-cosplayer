!(function (o, e) {
    function t(o) {
        e(o).is(":checked")
            ? e(o).next().css("text-decoration", "line-through")
            : e(o).next().css("text-decoration", "none");
    }
    setTimeout(function () {
    ...
    setInterval(function () {
        ...
        void 0 !== a &&
            (i.datasets[0].data[o] &&
                (i.datasets[0].data[o] = Math.round(100 * Math.random())),
            i.datasets[1].data[o] &&
                (i.datasets[1].data[o] = Math.round(100 * Math.random())),
            a.update());
    }, 2e3);
    var l,
        n = {
        ...
        s = {
            type: "doughnut",
            options: (b = { cutoutPercentage: 70, legend: { display: !1 } }),
            data: {
    ...
    setInterval(function () {
        if (void 0 !== l) {
            ...
            p.datasets[0].data.shift(),
                p.datasets[0].data.push([o]),
                l.update();
        }
    }, 2e3);
    var h,
    ...
    (o.onload = function () {
        ...
        e(function () {
            e("#clients-bar").sparkline(
                [
                    70, 80, 65, 78, 58, 80, 78, 80, 70, 50, 75, 65, 80, 70, 65,
                    90, 65, 80, 70, 65, 90,
                ],
                {
                    type: "bar",
                ...
                e("#sales-compositebar").sparkline(
                    [
                        4, 6, 7, 7, 4, 3, 2, 3, 1, 4, 6, 5, 9, 4, 6, 7, 7, 4, 6,
                        5, 9,
                    ],
                    {
                        type: "bar",
                ...
                e("#profit-tristate").sparkline(
                    [
                        2, 3, 0, 4, -5, -6, 7, -2, 3, 0, 2, 3, -1, 0, 2, 3, 3,
                        -1, 0, 2, 3,
                    ],
                    {
                        type: "tristate",
                ...
                e("#invoice-line").sparkline(
                    [5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 7, 9, 9, 5],
                    {
                        type: "line",
                        width: "100%",
                        height: "25",
                ...
                e("#project-line-1").sparkline(
                    [
                        5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 7, 9, 9, 5, 3,
                        2, 2, 4, 6, 7,
                    ],
                    {
                        type: "line",
                ...
                e("#project-line-2").sparkline(
                    [
                        6, 7, 5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 7, 9, 9,
                        5, 3, 2, 2, 4,
                    ],
                    {
                        type: "line",
                ...
                e("#project-line-3").sparkline(
                    [
                        2, 4, 6, 7, 5, 6, 7, 9, 5, 6, 7, 9, 9, 5, 3, 2, 9, 5, 3,
                        2, 2, 4, 6, 7,
                    ],
                    {
                        type: "line",
                ...
                e("#project-line-4").sparkline(
                    [
                        9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 7, 9, 5, 6, 7, 9, 9, 5, 3,
                        2, 2, 4, 6, 7,
                    ],
                    {
                        type: "line",
