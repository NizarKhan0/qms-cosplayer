...
<div class="max-w-2xl p-4 mx-auto">
    <div wire:poll="reloadFans" class="space-y-6">
        ...
        <div class="text-center">
            <h4 class="text-xl font-semibold text-gray-800">Join {{ $cosplayerName }}'s Queue</h4>
            <p class="text-sm text-gray-600">Fill out the form below to join the queue and stay updated on your position.</p>
        </div>
                ...
                <div class="mt-4">
                    ...
                    <ul class="mt-4 space-y-4">
                        @forelse ($callInQueue as $queue)
                            <li class="flex flex-col items-center p-4 rounded-lg shadow-sm bg-gradient-to-r from-blue-50 to-blue-100">
                                <span class="text-lg font-semibold text-gray-700">Queue #{{ $queue->queue_number }}</span>
            ...
            <div class="mt-6">
                @if ($userQueueInfo)
                    <div class="p-4 text-center bg-teal-100 rounded-lg">
                        ...
                        <p class="mt-2 text-teal-700"><strong>Queue Number:</strong> #{{ $userQueueInfo['queue_number'] }}</p>
                ...
                @else
                    <form wire:submit="registerQueue" class="p-4 space-y-6 bg-white rounded-lg shadow-md">
                        <!-- Name Input -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-center text-gray-700">Your Name</label>
                        ...
                        <!-- Submit Button -->
                        <div class="text-center">
                            <button type="submit" class="w-full py-3 font-semibold text-white rounded-lg bg-gradient-to-r from-teal-400 to-teal-600 hover:bg-gradient-to-l from-teal-500 to-teal-700">
                                Join Queue
                            </button>
                        </div>
                    </form>
