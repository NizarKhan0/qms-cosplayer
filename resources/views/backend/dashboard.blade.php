                ...
                <div class="col s12 m6 l3">
                    <div class="card animate fadeLeft">
                        <div class="card-content cyan white-text">
                            <p class="card-stats-title"><i class="material-icons">person_outline</i> New
                                Clients</p>
                ...
                <div class="col s12 m6 l3">
                    <div class="card animate fadeLeft">
                        <div class="card-content red accent-2 white-text">
                            ...
                            <p class="card-stats-compare">
                                <i class="material-icons">keyboard_arrow_up</i> 70% <span
                                    class="red-text text-lighten-5">last
                                    month</span>
                            </p>
                        </div>
                ...
                <div class="col s12 m6 l3">
                    <div class="card animate fadeRight">
                        <div class="card-content orange lighten-1 white-text">
                            <p class="card-stats-title"><i class="material-icons">trending_up</i> Today
                                Profit</p>
                ...
                <div class="col s12 m6 l3">
                    <div class="card animate fadeRight">
                        <div class="card-content green lighten-1 white-text">
                            <p class="card-stats-title"><i class="material-icons">content_copy</i> New
                                Invoice</p>
                            ...
                            <ul class="p-0 mb-0 collection right-sidebar-chat">
                                <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                    ...
                                    <div class="user-content">
                                        ...
                                        <p class="pt-3 medium-small blue-grey-text text-lighten-3">Thank
                                            you</p>
                                    </div>
                                ...
                                <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                    ...
                                    <div class="user-content">
                                        ...
                                        <p class="pt-3 medium-small blue-grey-text text-lighten-3">Hello
                                            Boo</p>
                                    </div>
                                ...
                                <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                    ...
                                    <div class="user-content">
                                        ...
                                        <p class="pt-3 medium-small blue-grey-text text-lighten-3">Do it
                                        </p>
                                    </div>
                                ...
                                <li class="pb-0 pl-5 collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar"
                                    ...
                                    <div class="user-content">
                                        ...
                                        <p class="pt-3 medium-small blue-grey-text text-lighten-3">Leave
                                            it</p>
                                    </div>
